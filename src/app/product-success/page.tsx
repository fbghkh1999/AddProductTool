        ...
        <div className="p-8 sm:p-10 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a
              ...
              className="px-8 py-4 bg-[#1C2575] text-white text-sm font-semibold rounded-xl hover:bg-[#151d5f] transition-all flex items-center justify-center gap-2"
            >
            ...
            <button
              onClick={() => router.push('/')}
              className="px-8 py-4 bg-white border border-[#E5E5EA] text-[#3D3D4E] text-sm font-semibold rounded-xl hover:bg-[#F5F5F7] transition-all flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
